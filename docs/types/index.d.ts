...
/**
* Interface describing `sreplicate`.
*/
interface Routine {
	/**
	...
	*/
	( N: number, k: number, x: Float32Array, strideX: number, out: Float32Array, strideOut: number ): Float32Array;
	...
	* // out => <Float32Array>[ 1.0, 1.0, 2.0, 2.0, 3.0, 3.0 ]
	*/
	ndarray( N: number, k: number, x: Float32Array, strideX: number, offsetX: number, out: Float32Array, strideOut: number, offsetOut: number ): Float32Array;
}
...
* // out => <Float32Array>[ 1.0, 1.0, 2.0, 2.0, 3.0, 3.0 ]
*/
declare var sreplicate: Routine;
